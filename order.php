    ...
    if(isset($_SESSION['loggedin'])){
        ...
        if($payment_method == 'credit'){
            ...
            function validateCreditCard($cardNumber, $expiryMonth, $expiryYear, $cvv, $name) {
                ...
                if(empty($cardNumber)){
                    $Errnumber = "Credit Card Number is empty";
                    return false;
                }
                ...
                if(empty($expiryMonth)){
                    $Errmonth = "Credit Card Expiry month is empty";
                    return false;
                }
                ...
                if(empty($expiryYear)){
                    $Erryear = "Credit Card Year Expiry is empty";
                    return false;
                }
                ...
                if(empty($cvv)){
                    $Errcvv = "Credit Card CVV Number is empty";
                    return false;
                }
                        ...
                        if($result){
                            ...
                            if($new_cart){
                                ...
                                while($rows=mysqli_fetch_assoc($newquery)){
                                    ...
                                    $deletequery = "delete from cart where prod_id='$prod_id' and user_id='$user_id'";
...
<body>
    ...
    <section class="checkout spad" style="padding-bottom:0rem;">
        <div class="container">
    ...
    <section class="checkout spad" style="padding-top:1rem;">
        <div class="container">
            <h4>Payment Method</h4>
         
            <input type="radio" name="payment" value="credit" onclick="showForm()" style="margin-left:18rem;  height:1rem; width:2%;"><label style="margin-left:0.5rem; font-size:1.5rem;">Credit Card </label> 
            
            <input type="radio" name="payment" value="cash" onclick="hideForm()" style="margin-left:18rem;  height:1rem; width:2%; padding-top:2rem;"><label style="padding-top:2rem; margin-left:0.5rem; font-size:1.5rem;">Cash on Delivery </label> 
            
            <div class="credit-card-form" id="myForm" style="visibility: hidden;">
            <form>
        
  
    <div class="form-group">
      <label for="card-number">Card Number</label><span class="error"><?php echo $Errnumber ; ?></span>
      <input type="text" id="card-number" name="cardNumber" placeholder="0000 0000 0000 0000" >
      
    </div>
    <div style="display:flex;">
    <div class="form-group">
      <label for="expirymonth">Expiry Month</label><span class="error"><?php echo $Errmonth ; ?></span>
      <input type="text" id="expirymonth" name="expiryMonth" placeholder="MM" style="width:3rem;">
    </div>
    <div class="form-group">
      <label for="expiryyear" style="margin-left:0.5rem; ">Expiry Year</label><span class="error"><?php echo $Erryear ; ?></span>
      <input type="text" id="expiryyear" name="expiryYear" placeholder="YYYY" style="width:4rem;">
      
    </div>
    <div class="form-group" style="margin-left:0.5rem;">
      <label for="cvv">CVV</label><span class="error"><?php echo $Errcvv ; ?></span>
      <input type="text" id="cvv" name="cvv" placeholder="123" style="width:4rem;" >
     
    </div>
</div>
    <div class="form-group">
      <label for="name">Name on Card Holder</label><span class="error"><?php echo $Errname ; ?></span>
      <input type="text" id="name" name="name" placeholder="Name of card holder" >
...
<div style="display:flex;">
<input type="submit" name="submit" value="ORDER" class="primary-btn" style="margin-left:0rem; padding-top:0.5rem; padding-bottom:0.5rem; margin-top:0.5rem; background-color:white; color:red;">
<a href="cart.php" ><button type="submit" class="primary-btn" style="margin-left:1rem; padding-top:0.5rem; padding-bottom:0.5rem; margin-top:0.5rem;  background-color:white; color:red;">CANCEL</button></a>
