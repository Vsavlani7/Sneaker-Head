                ...
                <form action="#" method="POST">
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <p style="font-size: 12px;">By loggin in you are agreeing the <a href="privacypolicy.php" style="text-decoration: underline;">privacy policy</a> of the Sneaker Head</p>
