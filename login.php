                ...
                <form action="#" method="POST">
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <p style="font-size: 12px;">By loggin in you are agreeing the <a href="privacypolicy.php" style="text-decoration: underline; color:blue;">privacy policy</a> of the Sneaker Head</p>
                            ...
                            <p style="font-size: 0.85rem;  margin-left:13.5rem;  padding:0.3rem;">Create account<a href="register.php" style="text-decoration: underline; margin-left:0.5rem; color:red;">Register</a></p>
                        </div>
                    </div>
                </form>
            </div>
