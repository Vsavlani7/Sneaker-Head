...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    if(isset($_SESSION['loggedin'])){
        ...
        if($payment_method == 'credit'){
            if (validateCreditCard($cardNumber, $expiryMonth, $expiryYear, $cvv)) {
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text" name="country" disabled="disabled" value="India">
                            </div>
                            <div class="checkout__input">
...
<a href="cart.php" ><button type="submit" style="margin-left:1rem; padding-right:2rem; padding-left:2rem;">Back</button></a>
</form>
</div>
</div>
    </section>
