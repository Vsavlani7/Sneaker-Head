    ...
    <section class="shopping-cart spad" style="padding-top:2rem;">
					...
					<form action="" method="POST">
                        ...
                        <table style="border-spacing: 1rem; border-collapse:unset;">
                            ...
                            <tbody >
							<?php
							$query2 = "select * from wishlist JOIN shoe on shoe.id=wishlist.prod_id  where user_id= '$user_id'";
                                ...
                                <tr style="background-image: url(white.jpg); border-radius:1.6rem;  box-shadow: 0px 5px 15px rgb(0, 0, 0, 0.3);">
                                    <td class="product__cart__item">
                                        ...
                                        <div class="product__cart__item__text">
                                            ...
                                            <h7>Price : <h7 style="color:red;">₹<?php echo $price ; ?>
                                        </div>
                                    </td>
                                    <td ><a href="deletewish.php?id=<?php echo $id; ?>" class="primary-btn" style="padding:0.4rem; letter-spacing:0.1rem; border-radius:0.4rem; color:black; background-color:white">Remove</a></td>
                                    <td ><a href="sneaker_detail.php?add_to_cart=<?php echo $id ?>" class="primary-btn" style="padding:0.4rem; letter-spacing:0.1rem; border-radius:0.4rem; color:red; background-color:white">View in Detail</a></td>
                                </tr>
								<?php
							}
							?>
