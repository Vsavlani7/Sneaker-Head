...
$email = $password = $otp = "";
$email_err = $password_err = $login_err = $otp_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    } else 
	{
        ...
        if ($result->num_rows == 1) {
            ...
            $otp_err = "Please enter valid OTP.";
        }
    }
    // Validate credentials
    if(empty($email_err) && empty($password_err) && empty($otp_err))
	{
...
<body style="overflow-x: hidden; background-image: url(images/login2.png); background-repeat:no-repeat; background-size: 70%; background-position-y: 100% ; background-position-x: 45% ;">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        <p>OTP<span  class="error">*<?php echo $otp_err ?></span></p>
                                        <input type="otp" name="otp" placeholder="Enter Your OTP">
                                    </div>
                                </div>
                            </div>
