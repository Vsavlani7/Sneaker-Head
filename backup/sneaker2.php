...
if(isset($_POST['addwish'])){
		...
		$shoe_id = $rows['id'];
		$sql_query= "select * from wishlist where prod_id='$shoe_id' and user_id='$user_id'";
		$select_cart = mysqli_query($con,$sql_query);
		if(mysqli_num_rows($select_cart) > 0){
			echo "Product already exist";
		}else{
			$new_query = "insert into wishlist(user_id,prod_id,brand,name,image,price,quantity,color,code) values ('$user_id','$shoe_id','$shoe_brand','$shoe_name','$shoe_image','$shoe_price','$shoe_quantity','$shoe_color','$shoe_code')" ;
							...
							<form id="filter_form" method="get">
                                <div class="shop__product__option__right" style="position:inherit; right:40px;">
                                    ...
                                    <select name="brand" id="brand" onchange="submitForm()">
                                        ...
                                        <option value="AirJordan">Jordan</option>
                                    </select>
                                </div>
								</form>
                            </div>
					...
					?>
						<div class="col-lg-3 col-md-5 col-sm-5" >
                            <div class='product__item' >
								...
								<input type="hidden" name="shoe_image" value="<?php echo $image ; ?>" ></a>
                                ...
                                <div class='product__item__text'>
									...
									<input type="hidden" name="shoe_price" value="<?php echo $price; ?>">
