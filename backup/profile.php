            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="shopping__cart__table">
                       ...
                       <h6>First Name :</h6>
                       <h6 style="padding-left:0.5rem; color:#786363;">Vishal</h6>
                        </div>
                        <div  style="display:flex; padding-top:1rem;">
                       <h6>Last Name :</h6>
                       <h6 style="padding-left:0.5rem; color:#786363;">Savlani</h6>
                        </div>
                        <div  style="display:flex; padding-top:1rem;">
                       <h6>City :</h6>
                       <h6 style="padding-left:0.5rem; color:#786363;">Surat</h6>
                        </div>
                        <div  style="display:flex; padding-top:1rem;">
                       <h6>Phone :</h6>
                       <h6 style="padding-left:0.5rem; color:#786363;">9586666118</h6>
                        </div>
                        <div  style="display:flex; padding-top:1rem;">
                       <h6>Email :</h6>
                       <h6 style="padding-left:0.5rem; color:#786363;">visshalsavlani44@gmail.com</h6>
                        </div>
                    </div>
                </div>
